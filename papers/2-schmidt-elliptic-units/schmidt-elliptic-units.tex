...
imprimitivity multipliers.  Every finite claim is machine-verified;
...
\midrule
\texttt{robert\_index\_full.py --selftest} & $n = 3, 5, 7, 9, 11, 13, 15$ (\texttt{--with-23}: $+\,n = 23$); needs PARI/GP 2.15.4 & 150d & 35 s ($+55$ s)\\
